...
static const TupleTableSlotOps *
heapam_slot_callbacks_test(Relation relation)
{
	return &TTSOpsBufferHeapTupleTest;
}
...
HeapTuple
heap_test_scan_getnext(TableScanDesc sscan, ScanDirection direction)
{
...
static double
IndexBuildHeapTestRangeScan(Relation heapRelation,
						Relation indexRelation,
						IndexInfo *indexInfo,
						bool allow_sync,
						bool anyvisible,
...
static const TableAmRoutine heapam_methods_test = {
	.type = T_TableAmRoutine,
	...
	.scan_begin = heap_beginscan,
	.scansetlimits = heap_setscanlimits,
	.scan_getnextslot = heap_getnextslot_test,
	.scan_end = heap_endscan,
	.scan_rescan = heap_rescan,
	.scan_update_snapshot = heap_update_snapshot,
...
Datum
heap_tableam_handler_test(PG_FUNCTION_ARGS)
{
	PG_RETURN_POINTER(&heapam_methods_test);
}
